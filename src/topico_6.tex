...
\begin{document}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{images/old/Q11 - Processing Infraestructure As-Is}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{images/old/Q12 - Storage Infraestructure As-Is}
